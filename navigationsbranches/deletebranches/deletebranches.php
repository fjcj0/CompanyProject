...
<head>
    ...
    <link rel="icon" href="https://img.icons8.com/?size=100&id=102350&format=png&color=000000">
    <style>
...
<body class="d-flex align-items-center justify-content-center flex-column">
    <h1>كافة الفروع للحذف</h1>
    <form action="" method="get" class="mt-3">
        <div class="input-group">
            <input type="search" class="form-control rounded" name="name" placeholder="بحث" aria-label="Search" value="<?php echo htmlspecialchars($search_name); ?>" />
    ...
    <div class="mt-4 cards d-flex flex-wrap align-items-center justify-content-center gap-5">
        <?php if ($branches_result && $branches_result->num_rows > 0): ?>
            <?php while ($branch = $branches_result->fetch_assoc()): ?>
                <form action="<?php echo htmlspecialchars('/company/controllers/BranchesControllers/deletebranch.php')?>" method="POST" class="card" style="width: 18rem;" enctype="">
