...
if(!$_REQUEST['branch_id']){
    header('Location: company/navigationsbranches/editbranches/editbranches.php');
    exit;
}
?>
<!DOCTYPE html>
...
<body class="d-flex align-items-center justify-content-center flex-column">
    <h1>تعديل الفرع</h1>
    <form method="POST" action="<?php echo htmlspecialchars("/company/controllers/BranchesControllers/editbranch.php"."?branch_id=".$_REQUEST['branch_id']); ?>" class="row g-3" style="z-index:995;" enctype="multipart/form-data">
        <div class="col-md-6">
        ...
        <div class="col-12">
            <button type="submit" class="btn btn-success">تعديل الفرع</button>
        </div>
    </form>
</body>
