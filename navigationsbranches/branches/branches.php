...
<head>
    ...
    <link rel="icon" href="https://img.icons8.com/?size=100&id=NkALtyX44JuW&format=png&color=000000">
    <style>
        ...
        <?php while ($branch = $branches_result->fetch_assoc()): ?>
            <div class="card" style="width: 18rem;">
                ...
                <div class="card-body">
                    ...
                    <a href="<?php echo htmlspecialchars("/company/navigationsbranches/informationbranch/informationbranch.php?branch_id=".$branch['id'])?>" class="btn btn-primary">عرض معلومات الفرع</a>
                </div>
            </div>
        <?php endwhile;?>
        <?php else: ?>
