...
<body>
    ...
    <div class="content-dashboard d-flex">
        <div class="d-flex flex-column text-white bg-dark silder-nav" id="silder-nav" style="width: 280px;">
            <div class="d-flex align-items-center text-white">
                <img src="https://img.icons8.com/?size=100&id=117508&format=png&color=000000" alt="" class="bi me-2"
                    style="width:4rem;">
            ...
            <ul class="nav nav-pills flex-column links-dashboard">
                <li class="nav-item">
                    <button type="button" class="nav-link text-white btn btn-dark button-home" id="button-home">
                        <img src="https://img.icons8.com/?size=100&id=41651&format=png&color=000000" alt=""
                            class="bi me-1" style="width:2.3rem; position:relative; bottom: 0.2rem;">
                        الرئيسية
                    </button>
                </li>
                <li>
                    <button type="button" class="nav-link text-white btn btn-dark button-buy" id="button-product-buy">
                        <img src="https://img.icons8.com/?size=100&id=VRbCAbUTUPby&format=png&color=000000" alt=""
                            class="bi me-1" style="width:2.3rem; position:relative;">
                        بضائع مستوردة
                    </button>
                </li>
                <li>
                    <button type="button" class="nav-link text-white btn btn-dark button-export"
                        id="button-exported-goods">
                        <img src="https://img.icons8.com/?size=100&id=8chNl15hy6jY&format=png&color=000000" alt=""
                            class="bi me-1" style="width:2.3rem; position:relative;">
                        بضائع مصدرة الى الافرع
                    </button>
                </li>
                <li>
                    <button type="button" class="nav-link text-white btn btn-dark button-branch"
                        id="button-our-branches">
                        <img src="https://img.icons8.com/?size=100&id=Hn4L8YBSZXh5&format=png&color=000000" alt=""
                            class="bi me-1" style="width:2.3rem; position:relative;">
                        فروعنا
                    </button>
                </li>
                <li>
                    <button type="button" class="nav-link text-white btn btn-dark button-probality"
                        id="button-probality">
                        <img src="https://img.icons8.com/?size=100&id=y8GdDkGlpWoA&format=png&color=000000" alt=""
                            class="bi me-1" style="width:2.3rem; position:relative;">
                        احصائية
                    </button>
                </li>
                <li>
                    <button type="button" class="nav-link text-white btn btn-dark button-setting"
                        id="button-setting-dashboard">
                        <img src="https://img.icons8.com/?size=100&id=13108&format=png&color=000000" alt=""
                            class="bi me-1" style="width:2.3rem; position:relative;">
                        الإعدادات
                    </button>
                </li>
                <li>
                    <button type="button" class="nav-link text-white btn btn-dark button-profile" id="button-profile">
                        <img src="https://img.icons8.com/?size=100&id=SS5zeu5HKnnG&format=png&color=000000" alt=""
                            class="bi me-1" style="width:2.3rem; position:relative;">
                        الملف الشخصي
                    </button>
                </li>
            ...
            <div class="d-flex flex-column justify-content-start align-items-start">
                <a href="https://porfile-ips.netlify.app" class="btn btn-warning mx-2">صفحة المبرمج</a>
                <a href="https://beprogrammer.org" class="btn btn-outline-info text-white mx-2 my-2">صفحة الشركة</a>
            </div>
        </div>
        <!--EDN SLIDER NAV-->
        <div class="content-slot-dashboard">
            <!--HEADER-->
            <header class="py-3 bg-dark text-white mx-auto mt-3 rounded-5" style="width: 90% ;">
                <div class="container">
            ...
            <div class="home container-fluid section mt-3" id="home">
                ...
                <div class="cards-info-home-dashboard mt-3 container-sm">
                    <div class="container">
                        <div class="row g-3">
                            <div class="col-lg-6">
                                <div class="card-home-dashboard d-flex justify-content-between align-items-center border bg-dark text-white"
                        ...
                        <div class="col">
                            <div class="card h-100 text-center shadow">
                                <div class="card-body">
                                    ...
                                    <p class="card-text text-muted">نسبة الاستيراد</p>
                                </div>
                            </div>
                        </div>
                        <div class="col">
                            <div class="card h-100 text-center shadow">
                                <div class="card-body">
                                    ...
                                    <p class="card-text text-muted">نسبة التصدير</p>
                                </div>
                            </div>
                        </div>
                        <div class="col">
                        ...
                        <div class="col">
                            <div class="card h-100 text-center shadow">
                                <div class="card-body">
                                    ...
                                    <p class="card-text text-muted">نسبة الخسائر</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="setting-dashboard container-sm mt-3 section" id="setting-dashboard">
                ...
                <div class="interface-settings my-2">
                    ...
                    <div class="row mt-2">
                        <select name="mode" id="mode" class="form-select p-3 mx-2 text-start" style="width: 95%;">
                            <div class="col">
                    ...
                    <button type="button" class="btn btn-dark btn-md px-4 py-2 mt-2">حفظ</button>
                </div>
            </div>
            <!--END SETTINGS-->
            <!--PROFILE-->
